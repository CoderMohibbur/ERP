<x-app-layout>
    <div class="max-w-7xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">➕ New Resignation</h2>

        <x-validation-errors class="mb-4" />

        <form method="POST" action="{{ route('employee-resignations.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div class="mb-4 md:col-span-2 lg:col-span-2">
                    ...
                    <textarea name="details" id="details" rows="4"
                              class="w-full px-4 py-2 border rounded-md dark:bg-gray-700 dark:text-white dark:border-gray-600">{{ old('details') }}</textarea>
                </div>
