<x-app-layout>
    <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Upload Project File</h2>
    ...
    <form action="{{ route('project-files.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            {{-- File Upload --}}
            <div>
                <label for="file" class="block mb-1 text-sm text-gray-600 dark:text-gray-300">File</label>
                <input type="file" name="file" id="file" class="w-full px-4 py-2 text-sm border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
