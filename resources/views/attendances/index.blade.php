        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 dark:text-gray-200">Date</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($attendances as $attendance)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-100">{{ $attendance->employee->name ?? '-' }}</td>
                        <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-100">{{ $attendance->date->format('Y-m-d') }}</td>
                        <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-100 capitalize">{{ $attendance->status }}</td>
                        <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-100">{{ $attendance->note ?? '-' }}</td>
