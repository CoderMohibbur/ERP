...
<div class="invoice-box">
    ...
    <table class="summary">
        <tr><td>Sub Total</td><td align="right">{{ $invoice->sub_total }}</td></tr>
        ...
        @endif
        <tr><td>Total Amount</td><td align="right">{{ $invoice->total_amount }}</td></tr>
        <tr><td>Paid Amount</td><td align="right">{{ $invoice->paid_amount }}</td></tr>
        <tr><td>Due Amount</td><td align="right">{{ $invoice->due_amount }}</td></tr>
    </table>
