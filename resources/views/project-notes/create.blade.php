<x-app-layout>
    <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Add Project Note</h2>
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div>
                ...
                <textarea name="note" id="note" rows="5"
                          class="w-full px-4 py-2 text-sm border border-gray-300 rounded-md dark:bg-gray-700 dark:text-white">{{ old('note') }}</textarea>
            </div>
        </div>
