<x-app-layout>
    <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-4">Add Client Note</h2>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <textarea name="note" id="note" rows="4"
                          class="w-full px-4 py-2 text-sm border border-gray-300 rounded-md bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500">{{ old('note') }}</textarea>
            </div>
        </div>
